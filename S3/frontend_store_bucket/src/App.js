  ...
  return (
    <Grid container direction="column" justifyContent="center" alignItems="stretch" className="appHeight100 appHideScroll">
      ...
      <Grid item container direction="row" justifyContent="flex-start" alignItems="stretch" className="appFixedHeight100">
        <Grid item xs={showLeftNav ? 2.5 : 0.5} sx={{ backgroundColor: (theme) => theme.palette.background.chatLeftPanel }}>
          <LeftNav showLeftNav={showLeftNav} setLeftNav={setLeftNav} />
        </Grid>
        <Grid
          container
          item
          xs={showLeftNav ? 9.5 : 11.5}
          direction="column"
        ...
        >
         <Grid item sx={{ height: '4rem' }}>
          ...
          <Grid
            ...
            alignItems="flex-end"
            sx={{
              height: { xs: "calc(100% - 4rem)", md: "calc(100% - 4rem)", lg: "calc(100% - 4rem)", xl: "calc(100% - 4rem)" },
            }}
          >
            <ChatBody />
          </Grid>
